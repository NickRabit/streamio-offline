...
export function App() {
  ...
  const openMeta = async (item: Meta) => {
    setSelected(item); setSelectedVideo(null); setEpisodesOpen(true); setStreams([]); setSelectedStream(null); setSubtitles([]); setSourcesLoaded(false);
